...
public class TagController {
    ...
    public TagDTO findTheMostWidelyUsedTag(@RequestParam String searchFor) {
        if (MOST_WIDELY_USED_SEARCH_PARAM.equals(searchFor)) {//todo ask is it norm or not
            ...
            throw new CertificateAppException("Resource not found", HttpStatus.NOT_FOUND, this.getClass());
        }
    }
}
